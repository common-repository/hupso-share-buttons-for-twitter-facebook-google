...
$hupso_all_services = array(
	'Twitter', 'Facebook', 'Pinterest', 'Linkedin', 'Tumblr', 'StumbleUpon', 'Digg', 'Reddit', 'Bebo', 'Delicious', 'VKontakte', 'Odnoklassniki', 'Sina Weibo', 'QZone', 'Renren', 'Email', 'Print'
);
$hupso_default_services = array(
	'Twitter', 'Facebook', 'Pinterest', 'Linkedin', 'StumbleUpon', 'Digg', 'Reddit', 'Bebo', 'Delicious'
);	
