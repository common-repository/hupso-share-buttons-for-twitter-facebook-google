...
Add social share buttons to your posts or pages. Support for Twitter, Facebook, Linkedin, Pinterest, Tumblr, Reddit and others.
...
* All major social networks are supported: Twitter, Facebook (Facebook Share / Facebook Like / Facebook Send), Linkedin, Tumblr, Pinterest, StumbleUpon, Digg, Reddit, Bebo, Delicious, VKontakte, Odnoklassniki, Sina Weibo, QZone, Renren.
* Social media counters: Twitter Tweet, Facebook Like, Linkedin Share, Pinterest - Pin it 
...
* Localized counters: Tweet, Facebook Like, Facebook Share buttons can use translated versions (support for 73 languages)
